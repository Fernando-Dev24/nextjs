...
// Esta funcion se encargara de retornar el numero de paginas estaticas que nosotros le indiquemos, esto solamente se ejeuta en build time
...
const getPokemon = async (name: string): Promise<Pokemon> => {
  try {
    const pokemon = await fetch(`https://pokeapi.co/api/v2/pokemon/${name}`, {
      //cache: "force-cache",
      next: {
        revalidate: 60 * 60 * 30 * 6, // re validacion de 6 meses
      },
    }).then((resp) => resp.json());
